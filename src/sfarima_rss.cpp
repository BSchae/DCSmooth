...
// /*** R
// sfarima_rss(theta = c(0.2, 0.2, 0.3, 0.2, 0.4, 0.2, 0.3), R_mat = matrix(1:12, 3, 4), model_order = list(ar = c(1, 2), ma = c(1, 1)),
//             K1 = 200, K2 = 200)
// sfarima.rss(theta = c(0.2, 0.2, 0.3, 0.2, 0.4, 0.2, 0.3), R_mat = matrix(1:12, 3, 4), model_order = list(ar = c(1, 2), ma = c(1, 1)),
//             K1 = 200, K2 = 200)
// */
