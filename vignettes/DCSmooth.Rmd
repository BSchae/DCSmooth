...
+`"sarma_RSS` (estimation of an SARMA process by numerical minimization of the RSS)
...
## 2.3 Data
This package contains three simulated example data sets and two data sets of temperature surfaces.
...
The application data sets feature the temperature surfaces of Nunn, CO (`temp.nunn`) and Yuma, AZ (`temp.yuma`). The observations are taken in 2020 in 5-minute intervals and are given in Celsius. Both data sets consist therefore of 288 colums (the intraday observations) and 366 rows (the days). The data is from the U.S. Climate Reference Network database at \url{https://www.ncdc.noaa.gov/crn/qcdatasets.html}. (see Diamond et. al. (2013), \href{https://journals.ametsoc.org/view/journals/bams/94/4/bams-d-12-00170.1.xml}{doi:10.1175/BAMS-D-12-00170.1}).
...
opt_lm = set.options(var_model = "sfarima_RSS")
