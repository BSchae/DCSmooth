...
#'   \mathbb{I}}{0.1 I}, where 
#'   \eqn{\mathbb{I}}{I} represents the \eqn{2 \times 2}{2 x 2} identity matrix.
#'   
...
#'   at \eqn{(0.5, 0.3)} with variance matrix \eqn{0.1 \cdot \mathbb{I}}{0.1 I}
#'   and at \eqn{(0.2, 0.8)} with variance matrix \eqn{0.05 \cdot \mathbb{I}}{
#'   0.05 I}, where 
#'   \eqn{\mathbb{I}}{I} represents the \eqn{2 \times 2}{2 x 2} identity matrix.
#'   
#' @format A numeric matrix with 101 rows and 101 columns.
...
#'   \eqn{(0.01, -0.1) \cdot \mathbb{I}}{(0.01, -0.1) I} and at
#'   \eqn{(0.75, 0.5)} with variance matrix
#'   \eqn{(0.01, -0.1) \cdot \mathbb{I}}{(0.01, -0.1) I}, where 
#'   \eqn{\mathbb{I}}{I} represents the \eqn{2 \times 2}{2 x 2} identity matrix.
#'   
#' @format A numeric matrix with 101 rows and 101 columns.
"y.norm3"
