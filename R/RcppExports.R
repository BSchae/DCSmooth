...
KRSlow_single <- function(yVec, h, kernFcnPtr) {
    .Call(`_DCSmooth_KRSlow_single`, yVec, h, kernFcnPtr)
}

KR_DSSlow <- function(yMat, hVec, drvVec, kernFcnPtrX, kernFcnPtrT) {
    .Call(`_DCSmooth_KR_DSSlow`, yMat, hVec, drvVec, kernFcnPtrX, kernFcnPtrT)
}
