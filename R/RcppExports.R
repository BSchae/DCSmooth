...
KRSmooth_matrix <- function(yMat, h, kernFcnPtr) {
    .Call('_DCSmooth_KRSmooth_matrix', PACKAGE = 'DCSmooth', yMat, h, kernFcnPtr)
}
...
kernFkt_MW220_old <- function(u, q = 1) {
    .Call('_DCSmooth_kernFkt_MW220_old', PACKAGE = 'DCSmooth', u, q)
}
...
MWTest1 <- function(uVec, q) {
    .Call('_DCSmooth_MWTest1', PACKAGE = 'DCSmooth', uVec, q)
}

MWTest2 <- function(u, q) {
    .Call('_DCSmooth_MWTest2', PACKAGE = 'DCSmooth', u, q)
}

LPSmooth_matrix2 <- function(yMat, h, polyOrder, drv) {
    .Call('_DCSmooth_LPSmooth_matrix2', PACKAGE = 'DCSmooth', yMat, h, polyOrder, drv)
}

LP_DoubleSmooth2 <- function(yMat, hVec, polyOrderVec, drvVec) {
    .Call('_DCSmooth_LP_DoubleSmooth2', PACKAGE = 'DCSmooth', yMat, hVec, polyOrderVec, drvVec)
}
